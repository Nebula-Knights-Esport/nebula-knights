  ...
  const players = [
    {
      ...
      name: "Real Name",
      role: "Main AR",
      image: "/players/academy/player1.png",
    },
    {
      gamertag: "Player Two",
      name: "Real Name",
      role: "SMG",
      image: "/players/academy/player2.png",
    },
    {
      gamertag: "Player Three",
      name: "Real Name",
      role: "Flex",
      image: "/players/academy/player3.png",
    },
    {
      gamertag: "Player Four",
      name: "Real Name",
      role: "Slayer",
      image: "/players/academy/player4.png",
    },
  ];
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-5xl mx-auto px-8 text-center pb-20">
          ...
          <p className="text-gray-300 leading-relaxed">
            Academy represents the highest level of competitive Call of Duty
            within Nebula Knights Esports. Built on teamwork, discipline and
            excellence, Academy competes to establish itself among the top
            teams in the region.
          </p>
